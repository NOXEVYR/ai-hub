...
**本地 AI 资产与协作工作台，原名 AI Hub。** 2.13.0 新增按用途与工作端分类的能力中心，扩展本机 Skill / 插件接口发现，支持自定义来源，完善右键菜单和首次工作区引导。保留 2.12 的自动与手动更新。[本次更新](docs/RELEASE_2.13.0.md) · [软件更新说明](docs/SOFTWARE_UPDATES.md)。
