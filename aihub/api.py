...
ROUTES = [
    ...
    ("GET", r"^/api/health$", lambda db, cfg, params, body: _json_bytes({"app": "ai-hub", "version": "2.11.2", "desktop_shell_version": "2.11.2", "jobs_running": any(j["status"] == "running" for j in jobs.get_jobs())})),
