...
(function(root, factory) {
  ...
  function welcome(configured = false) {
    const content = `<h3>把 AI 工具、能力和工作成果放在同一个工作台</h3><p>曜核帮你管理资源位置、发现 Skill 与接口，并把任务、报告和长期记忆关联到项目。图像生成、视频创作和代码执行仍由各自的工具完成。</p><div class="ws-steps"><div><strong>01 · 选择工作目录</strong><p>新电脑选一个空目录；已有资源就接入原来的目录。先预览布局，再确认创建。</p></div><div><strong>02 · 发现并接入能力</strong><p>查看本机 Skill、图像 / 视频 / 语音接口，再登记你实际使用的工作端。</p></div><div><strong>03 · 建项目，交接任务</strong><p>为每个项目分开输入、过程和交付，将执行结果与报告归档。</p></div></div><a class="btn primary" href="#/workspace">${configured?'管理工作环境':'开始设置工作环境'}</a><a class="btn" href="#/capabilities">查看本机能力</a>`;
    return configured ? `<details class="ws-start"><summary>使用指南 · 工作区、能力和任务如何配合</summary>${content}</details>` : `<section class="ws-start">${content}</section>`;
  }
  ...
  return {createPage,capture,banner,welcome,lines,healthHTML,previewHTML,toolsHTML,projectPreviewHTML};
});
