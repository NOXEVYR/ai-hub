...
test('reorganized navigation preserves all routes, action IDs and module loading order',()=>{
  ...
  for(const module of ['navigation.js','workspace.js','collaboration.js','workcenter.js','capabilities.js','context-menu.js'])assert(index.indexOf(`src="${module}"`)<index.indexOf('src="app.js"'));
  assert.match(index,/brand-lumacore\.svg/);assert.match(index,/v2\.9\.0/);
